<?php
    ...
    if($_POST['btnsubmit']){    
        ...
        $user_comment = $_POST['contact_comments'];
        ...
        $mail = new PHPMailer(true);
            ...
            $mail->SMTPAuth   = true;                                   
            $mail->Username   = 'cpe.elibrary@gmail.com';   // GMAIL ACCOUNT MO
            $mail->Password   = 'cpeelibrary2022';           // PASSWORD NG GMAIL MO
            $mail->SMTPSecure = 'ssl';            
            $mail->Port       = 465;                                    

            //CPE ELIBRARY SEND EMAIL
            $mail->setFrom('cpe.elibrary@gmail.com', 'CPE E-LIBRARY');
            $mail->addAddress('cpe.elibrary@gmail.com', 'CPE E-LIBRARY');   //Add a recipient
            $body = "<br><b>Name:</b> $user_name 
            <br><b>User Email:</b> $user_email
            <br><b>Concerns:</b> $user_comment
            ";

            //CPE ELIBRARY BODY EMAIL
            $mail->isHTML(true);                               
            $mail->Subject = 'User Concerns';
            $mail->Body    = $body;

            $mail->send();
            echo "<div class='alert alert-success' role='alert'  style='margin-bottom:-8px;'>
        ...
        <nav class="navbar navbar-dark navbar-expand float-right align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="background-image: url(&quot;none&quot;);background-color: rgb(239,210,106);">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item" role="presentation"><a class="nav-link" href="browse.php" style="color: rgb(13,0,3);"><i class="fas fa-table" style="color: rgb(13,1,1);"></i><span>Browse</span></a><a class="nav-link active" href="contacts.php" style="color: rgb(13,0,3);"><i class="fab fa-slack-hash" style="color: rgb(13,1,1);"></i><span>Contact</span></a>
                        <a
                    ...
                    <form id="contactForm" style="padding:15px;" method="POST">
                        <div class="form-row" style="margin-left: 0px;margin-right: 0px;padding: -16px;">
                            <div class="col-md-6" style="padding-left:20px;padding-right:20px;">
                                <fieldset></fieldset>
                                <legend style="color: rgb(14,15,23);">&nbsp;Contact Us</legend>
                                <p></p>
                                    ...
                                    <table class="table">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td style="color: rgb(8,89,237);"><a href="https://www.facebook.com/PUPCpEOfficial/">PUP Computer Engineering Department</td></a>
                                            </tr>
                                            <tr>
                                                <td><i class="fa fa-map-marker" style="color: rgb(2,2,4);"></i></td>
                                                <td style="color: rgb(8,89,237);">PUP College of Engineering and Architecture Building 1008 Manila, Philippines</td>
                                            </tr>
                                            <tr>
                                                <td><i class="fa fa-phone" style="color: rgb(3,4,11);"></i></td>
                                                <td style="color: rgb(8,89,237);">277136009</td>
                                            </tr>
                                            <tr>
                            ...
                            <div class="col-12 col-md-6" id="message" style="padding-right:20px;padding-left:20px;">
                                ...
                                <div class="form-group"><label for="comments" style="color: rgb(5,6,11);">Concerns</label><textarea class="form-control" id="contact_comments" name="contact_comments" placeholder="Enter your Concerns" rows="5"></textarea></div>
